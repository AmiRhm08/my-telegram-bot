...
def handle_messages(message):
    ...
    # وقتی دکمه "دلم واست تنگولیده." رو زد — یکی از پیام‌های عاشقانه اصلی رو بفرست
    if "دلم واست تنگولیده" in text:
        romantic_reply = get_next_message(chat_id)  # همون تابع پیام ساعتی
        bot.reply_to(message, f"{romantic_reply}\n\دلم برات هر لحظه تنگولیده مریم جونم.❤️")
